...
import { Forwarder } from "../../libs/proxy/Forwarder.sol";
...
contract Owns is ERC721, ERC721URIStorage, ERC721Enumerable {
    using SafeCast for *;
...
/**
 * Forwarder whose caller is the NFT owner
 */
contract Own is Forwarder {
    
    Owns public collection;
